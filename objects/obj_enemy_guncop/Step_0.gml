...
if (place_meeting(x, y, obj_hitbox_walt_attack_1) || place_meeting(x, y, obj_hitbox_walt_attack_2))
{
    if (!(place_meeting(x, y, obj_wall_shield)))
    {
        ...
        instance_create_depth(x, y, -10, obj_particle_guncop_dead_5)
...
if (place_meeting(x, y, obj_hitbox_spin) || place_meeting(x, y, obj_hitbox_doublejump) || place_meeting(x, y, obj_hitbox_groundpound) || place_meeting(x, y, obj_object_waterspout) || place_meeting(x, y, obj_object_collapse))
{
    if place_meeting(x, y, obj_hitbox_spin)
    {
        ...
        instance_create_depth(x, y, -10, obj_particle_guncop_dead_1)
        instance_create_depth(x, y, -10, obj_particle_guncop_dead_2)
        if drop
        {
    ...
    if place_meeting(x, y, obj_hitbox_doublejump)
    {
        ...
        instance_create_depth(x, y, -10, obj_particle_guncop_dead_3)
        instance_create_depth(x, y, -10, obj_particle_guncop_dead_4)
        if drop
        {
            instance_create_depth(x, y, -2, obj_item_gem_follow)
            instance_create_depth(x, y, -2, obj_item_gem_follow)
...
if instance_exists(obj_mick)
{
    if (point_distance(x, y, obj_mick.x, obj_mick.y) < 1200)
    {
        ...
        {
            script_execute(scr_stopsound_guncop_voice)
            scared_sound = irandom_range(0, 1)
            if (scared_sound == snd_item_gem_9)
                audio_play_sound(snd_enemy_guncop_scared_voice_1, 1, false)
            if (scared_sound == snd_mick_ui_wow_time)
                audio_play_sound(snd_enemy_guncop_scared_voice_2, 1, false)
            scared = 1
            scared_time = 30
            image_index = 0
        }
...
if (!ready)
    ...
    idle = spr_enemy_guncop_ready
if (scared_time > 0)
    scared_time -= 1
if (scared_time > 2)
{
    sprite_index = spr_enemy_guncop_scared
    if (image_index == 4)
        image_index = 2
}
if (scared_time == 2)
...
if attacking
{
    sprite_index = spr_enemy_guncop_attack
    if (image_index == 10)
    {
    }
    if (image_index > 23)
    ...
    if (image_index == 8)
    {
        audio_play_sound(snd_enemy_guncop_gun_1, 1, false)
        audio_play_sound(snd_enemy_guncop_attack_voice_1, 1, false)
    }
    if (image_index == 16)
    {
        audio_play_sound(snd_enemy_guncop_gun_2, 1, false)
        if (image_xscale == 1)
        {
            instance_create_depth((x - 100), (y - 2), -4, obj_hitbox_guncop_attack)
            instance_create_depth((x - 100), (y - 32), 10, obj_particle_gunshot)
        }
        else
        {
            instance_create_depth((x + 100), (y - 32), -4, obj_hitbox_guncop_attack).image_xscale = -1
            instance_create_depth((x + 100), (y - 32), 10, obj_particle_gunshot)
        }
    }
}
