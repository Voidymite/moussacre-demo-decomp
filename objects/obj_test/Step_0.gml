if (!gamepad_is_connected(0))
{
    ...
    global.action3 = keyboard_check_pressed(186);
    global.action5 = keyboard_check_pressed(222);
    global.action5 = keyboard_check(vk_lshift);
}
else
{
    gamepad_set_axis_deadzone(0, 0.24);
    global.left_hold = gamepad_button_check(0, gp_padl) || gamepad_axis_value(0, gp_axislh) < -0.3;
    global.right_hold = gamepad_button_check(0, gp_padr) || gamepad_axis_value(0, gp_axislh) > 0.3;
    global.up_hold = gamepad_button_check(0, gp_padu) || gamepad_axis_value(0, gp_axislv) < -0.3;
    global.down_tap = gamepad_button_check_pressed(0, gp_padd) || gamepad_axis_value(0, gp_axislv) > 0.5;
    global.down_hold = gamepad_button_check(0, gp_padd) || gamepad_axis_value(0, gp_axislv) > 0.3;
    ...
    global.action5 = gamepad_button_check(0, gp_shoulderrb) || gamepad_button_check(0, gp_shoulderlb);
}
...
if (place_meeting(x, y + 2, obj_wall))
{
    ...
    if (global.action1_release || !global.action1)
        jump_used = 0;
