if (!gamepad_is_connected(0))
{
    ...
    var left_tap = (keyboard_check_pressed(ord("A")) ? true : keyboard_check_pressed(vk_left))
    var right_tap = (keyboard_check_pressed(ord("D")) ? true : keyboard_check_pressed(vk_right))
    var action1 = (keyboard_check_pressed(ord("Z")) ? true : keyboard_check_pressed(vk_return))
    var action2 = (keyboard_check_pressed(ord("X")) ? true : keyboard_check_pressed(vk_backspace))
}
else
{
    pause = gamepad_button_check_pressed(0, gp_start)
    up_tap = (gamepad_button_check_pressed(0, gp_padu) ? true : (gamepad_axis_value(0, gp_axislv) < -0.3 ? true : (keyboard_check_pressed(ord("W")) ? true : keyboard_check_pressed(vk_up))))
    down_tap = (gamepad_button_check_pressed(0, gp_padd) ? true : (gamepad_axis_value(0, gp_axislv) > 0.3 ? true : (keyboard_check_pressed(ord("S")) ? true : keyboard_check_pressed(vk_down))))
    left_tap = (gamepad_button_check_pressed(0, gp_padl) ? true : (gamepad_axis_value(0, gp_axislh) < -0.3 ? true : (keyboard_check_pressed(ord("A")) ? true : keyboard_check_pressed(vk_left))))
    right_tap = (gamepad_button_check_pressed(0, gp_padr) ? true : (gamepad_axis_value(0, gp_axislh) > 0.3 ? true : (keyboard_check_pressed(ord("D")) ? true : keyboard_check_pressed(vk_right))))
    action1 = (gamepad_button_check_pressed(0, gp_face1) ? true : (keyboard_check_pressed(ord("Z")) ? true : keyboard_check_pressed(vk_return)))
    action2 = (gamepad_button_check_pressed(0, gp_face2) ? true : (keyboard_check_pressed(ord("X")) ? true : keyboard_check_pressed(vk_backspace)))
}
if (display_time > 0)
    display_time -= 1
if (up_tap ? true : down_tap)
    display_time = 1
if (time > 0)
    time -= 1
if (key_time > 0)
...
if (action2 && tab != 10 && tab != 11)
{
    ...
    if (tab == 2 ? true : (tab == 5 ? true : tab == 6))
    {
        cooldown = 1
        tab = 1
    }
    ...
    if (tab == 7 ? true : (tab == 8 ? true : tab == 9))
    {
        cooldown = 1
        tab = 6
    }
...
if (gamepad_axis_value(0, gp_axislv) <= 0.3 && gamepad_axis_value(0, gp_axislv) >= -0.3 && gamepad_axis_value(0, gp_axislh) <= 0.3 && gamepad_axis_value(0, gp_axislh) >= -0.3)
    tapped = 0
if (tab == 0 ? true : (tab == 1 ? true : (tab == 2 ? true : (tab == 5 ? true : tab == 6))))
{
    if (row < 0)
        row = 3
    if (row > 3)
...
if (tab == 10)
{
    ...
    if (keyboard_check_pressed(vk_anykey) && (!keyboard_check_pressed(vk_escape)) && (!cooldown))
    {
        ...
        if (row == 9)
            global.action6 = keyboard_lastkey
        if (row == 10)
