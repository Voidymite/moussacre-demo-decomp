...
if (place_meeting(x, y, obj_mick) || place_meeting(x, y, obj_hitbox_spin) || place_meeting(x, y, obj_hitbox_doublejump) || place_meeting(x, y, obj_hitbox_groundpound) || place_meeting(x, y, obj_hitbox_shoot) || place_meeting(x, y, obj_hitbox_hook_3) || place_meeting(x, y, obj_hitbox_bomb_2) || place_meeting(x, y, obj_hitbox_counter) || place_meeting(x, y, obj_hitbox_deflect) || place_meeting(x, y, obj_hitbox_rang))
{
    if (!open)
    {
        global.losses = 0;
        ...
        {
            instance_create_depth(-100, -100, -10001, obj_particle_addsub_2).num = global.hp_max;
            instance_create_depth(-100, -100, -10001, obj_particle_addsub_3).num = global.sp_max;
        }
        ...
        if (place_meeting(x, y, obj_hitbox_shoot) || place_meeting(x, y, obj_hitbox_hook_3) || place_meeting(x, y, obj_hitbox_bomb_2) || place_meeting(x, y, obj_hitbox_counter) || place_meeting(x, y, obj_hitbox_deflect))
